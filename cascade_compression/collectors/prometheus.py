...
PromQL queries cover common Kubernetes health signals. Alert classification
maps Alertmanager severity and lifecycle fields into the public signal contract.
"""
